...
if (empty($_SESSION["user_id"])) {
    header('location:login.php');
        ...
        if ($_POST['submit']) {
            ...
            if($_POST['mod'] == 'esewa'){
                echo "<script>window.location.replace('esewa.php');</script>"; 
            }
            ...
            <header id="header" class="header-scroll top-header headrom">
                <nav class="navbar navbar-dark">
                    <div class="container">
                        ...
                        <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/favicon.ico" alt=""> </a>
                                                ...
                                                <ul class=" list-unstyled">
                                                    ...
                                                    <li>
                                                        <label class="custom-control custom-radio  m-b-10">
                                                            <input name="mod" type="radio" value="esewa" 
                                                                class="custom-control-input"> <span
                                                                class="custom-control-indicator"></span> <span
                                                                class="custom-control-description">Esewa <img
                                                                    src="images/esewa.png" alt="" width="90"></span>
                                                        </label>
                                                        <li>
                                <a href="khalti.com"> <img src="images/esewa.png" alt="Khalti" height="50px"> </a>
                            </li>
                                                    </li>
                                                </ul>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                <li>
                                    <a href="#"> <img src="images/esewa.png" alt="Esewa"> </a>
                                </li>
