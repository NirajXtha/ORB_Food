...
<body class="fix-header fix-sidebar">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/favicon.ico" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="javascript:void(0);"
                                                            onClick="window.open('order_update.php?form_id=<?php echo htmlentities($rows['o_id']); ?>');"
                                                            title="Update order">
    ...
    <footer class="footer"> © 2024 - ORB food </footer>
